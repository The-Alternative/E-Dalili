            ...
            <form action="{{ route('products.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="@error('title') is-invalid
                     @enderror form-control" name="title" placeholder="Add a new product" value="">
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="@error('slug') is-invalid
                     @enderror form-control" name="slug" placeholder="Add product slug" value="">
                    @error('slug')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="@error('barcode') is-invalid
                     @enderror form-control" name="barcode" placeholder="Add barcode" value="" >
                    @error('barcode')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="@error('productcol') is-invalid
                     @enderror form-control" name="productcol" placeholder="Add Productcol" value="">
                    @error('productcol')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="@error('meta') is-invalid
                     @enderror form-control" name="meta" placeholder="Add Meta" value="">
                    @error('meta')
                    <div class="alert alert-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                            ...
                            <input type="checkbox" name="is_active" aria-label="Checkbox for following text input" >
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                            ...
                            <input type="checkbox" name="is_appear"  aria-label="Checkbox for following text input">
                        </div>
                    </div>
                </div>
                <div class="form-group">
